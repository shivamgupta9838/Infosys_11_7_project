...
public class ReportService {
    ...
    public JasperPrint generateReport(String reportPath, List<?> data, Map<String, Object> parameters)
        ...
        if (data != null && !data.isEmpty() && data.get(0) instanceof Map) {
            ...
            List<Map<String, ?>> mapData = (List<Map<String, ?>>) data;
            dataSource = new JRMapCollectionDataSource(mapData);
        } else {
        ...
        if (reportStream == null) {
            throw new RuntimeException("Report resource not found on classpath: " + reportPath);
        }
